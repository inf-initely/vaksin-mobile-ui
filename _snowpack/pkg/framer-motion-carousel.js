...
import { _ as __assign, a as __rest, i as invariant, c as __spreadArray, b as __read, d as __extends } from './common/hey-listen.es-f6cdd899.js';
...
var Dots = _ref => {
  ...
  return /*#__PURE__*/react.createElement("div", {
    style: dotWrapStyle
  }, new Array(length).fill("").map((_, i) => /*#__PURE__*/react.createElement("span", {
    onClick: () => setActiveIndex(i),
    key: i,
    style: _extends$2({}, dotItemStyle, {
...
var Carousel = _ref => {
  ...
  var handleEndDrag = (e, dragProps) => {
    ...
    if (offset.x > clientWidth / 4) {
      ...
      animate$1(x, calculateNewX(), transition);
    }
  };
  ...
  react.useEffect(() => {
    var controls = animate$1(x, calculateNewX(), transition);
    return controls.stop;
  }, [index]);
  react.useEffect(() => {
    if (!autoPlay) {
